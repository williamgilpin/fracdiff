...
def eq_dist(pts, pot_width):
    '''
    The radial gaussian distribution for my parametricization
    '''
...
def time_nondim(time, params):
    ...
    of time used for the nondimensional form of the reaction-diffusion equation
...
def radiff_timeop_nondim(timepoint, yvals, settings_and_params):
    ...
    KAPPA = KAPPA*( timepoint**( (1/ALPHA)-1 ) )
